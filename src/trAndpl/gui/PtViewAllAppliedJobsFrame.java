...
public class PtViewAllAppliedJobsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbleAllJobs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "JobID", "Job Title", "Company Name", "Skills Required"
            }
        ) {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 210, 30));

        BtnApplyForJobs.setBackground(new java.awt.Color(204, 204, 255));
        BtnApplyForJobs.setText("Take Quiz");
    ...
    private void BtnApplyForJobsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnApplyForJobsActionPerformed
      ...
      int row=tbleAllJobs.getSelectedRow();
        ...
        String jobId=tbleAllJobs.getValueAt(row,0).toString().trim();
        String jobTitle=tbleAllJobs.getValueAt(row,1).toString().trim();
