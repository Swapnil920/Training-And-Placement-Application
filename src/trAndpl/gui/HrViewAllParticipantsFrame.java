...
public class HrViewAllParticipantsFrame extends javax.swing.JFrame {
  ...
  private void loadAllParticipants()
    {
        try{
            AllParticipantsList=ParticipantsDAO.getAllParticipants();
            for(ParticipantsPojo viewAllPt:AllParticipantsList){
                ...
                row.add(viewAllPt.getPhone());
                row.add(viewAllPt.getSkills());
                row.add(viewAllPt.getQualifications());
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jPanel1.add(BtnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(802, 680, 130, -1));
        ...
        tbleAllPt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "P-ID", "User Id", "Name", "Phone No", "Skills", "Qulifications"
            }
        ) {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 680, 170, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pid=(String)tbleAllPt.getValueAt(row,0).toString().trim();
        HrViewUserProfileFrame ViewProfile=new HrViewUserProfileFrame(pid);
        this.dispose();
