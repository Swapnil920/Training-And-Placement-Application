...
public class HrChooseJobForEditingFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, 710, 240));
    ...
    private void BtnEditJobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditJobActionPerformed
        ...
        job.setJobId(tbleAllJobs.getValueAt(row, 0).toString().trim());
        job.setJobTitle(tbleAllJobs.getValueAt(row, 1).toString().trim());
        job.setTags(tbleAllJobs.getValueAt(row, 2).toString().trim());
